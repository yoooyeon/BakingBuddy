...
public class UserController {
     ...
     * @return
     */
    @GetMapping("intro/{username}")
    public ResponseEntity<SuccessResponse<SelectUserIntroResponseDto>>
    introUser(@PathVariable("username") String username) {
        SelectUserIntroResponseDto data = SelectUserIntroResponseDto.fromEntity(userService.selectIntroByUsername(username));
